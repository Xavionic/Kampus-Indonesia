        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5">
                ...
                <div class="btn btn-default btn-xl col-lg-3 col-md-6 text-center ">
                    ...
                    <p class="text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam feugiat
                        elementum leo in tristique.</p>
                </div>
                <div class="btn btn-default btn-xl col-lg-3 col-md-6 text-center">
                ...
                @else
                <div class="btn btn-default btn-xl col-lg-3 col-md-6 text-center" href="{{ route('login') }}">
                    <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                    <h3 class="h4 mb-2">Informasi Kampus</h3>
                    <p class="text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam feugiat
                        elementum leo in tristique.</p>
